...
<br/> :purple_heart: &nbsp; Sei um pouco de HTML, CSS e JS (o básicão para fazer um site rodar com funcionalidades básicas).
<br/> :computer: &nbsp; To começando os estudos em Python para ganhar uma base para partir pro Biopython.
